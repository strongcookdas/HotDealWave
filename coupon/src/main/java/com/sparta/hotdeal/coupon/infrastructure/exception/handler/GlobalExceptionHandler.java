package com.sparta.hotdeal.coupon.infrastructure.exception.handler;
...
import com.sparta.hotdeal.coupon.infrastructure.exception.ApplicationException;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponseDto> handleAccessDeniedException(AccessDeniedException e) {
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(new ErrorResponseDto(ApplicationErrorCode.FORBIDDEN_EXCEPTION, "Access is denied"));
    }
    ...
    public ResponseEntity<ErrorResponseDto> methodArgumentNotValidException(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity
                ...
                .body(new ErrorResponseDto(
                        ApplicationErrorCode.INVALID_VALUE_EXCEPTION,
