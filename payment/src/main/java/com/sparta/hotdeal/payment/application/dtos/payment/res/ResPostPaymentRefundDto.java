...
@Getter
@Builder
public class ResPostPaymentRefundDto {
    private String tid;
    ...
    public static ResPostPaymentRefundDto from(KakaoPayCancelDto kakaoPayCancelDto) {
        return ResPostPaymentRefundDto.builder()
